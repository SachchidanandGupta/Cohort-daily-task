const reelsData = [
  {
    ...
    profileImage:
      "https://i.pinimg.com/736x/bc/77/6a/bc776a402483d56ae6213783316eff18.jpg",
  ...
  },
  {
    ...
    profileImage:
      "https://i.pinimg.com/736x/2c/36/88/2c3688d7e305ec9057d76f2d0e567e4a.jpg",
  ...
  },
  {
    ...
    profileImage:
      "https://i.pinimg.com/736x/95/c8/e4/95c8e4eefeea1047a0e4b9c2754d6e2f.jpg",
  ...
  },
  {
    ...
    profileImage:
      "https://i.pinimg.com/736x/c6/76/c1/c676c1cd38fb6768578ebc0b51a5045a.jpg",
  ...
  },
  {
    ...
    profileImage:
      "https://i.pinimg.com/736x/f6/18/02/f61802b981b0a29980cb2ded9fe17b90.jpg",
  ...
  },
  {
    ...
    profileImage:
      "https://i.pinimg.com/1200x/12/b4/f6/12b4f64feeac5f488f3e82d0d2493e95.jpg",
  ...
  },
  {
    ...
    profileImage:
      "https://i.pinimg.com/736x/4f/81/f9/4f81f959f4e2caa62b26afaa0c49e212.jpg",
  ...
  },
  {
    ...
    profileImage:
      "https://i.pinimg.com/1200x/8c/ed/8b/8ced8bc8d614ec5de5efaeb6308a313d.jpg",
  ...
  },
  {
    ...
    profileImage:
      "https://i.pinimg.com/1200x/7d/9a/0e/7d9a0e45d91710a50c3bfc409f605b45.jpg",
...
function addData() {
  ...
  reelsData.forEach(function (elem, idx) {
    sum =
      sum +
      ` <div class="reels">
             <video src="${elem.video}" autoplay loop ${elem.isMuted ? "muted" : " "
      } ></video>
             <div class="mute" id="${idx}">${elem.isMuted
        ...
        : '<i class="ri-volume-up-fill"></i>'
            ...
            <div class="profile">
              ...
              <button class ="follow" id="${idx}">${elem.isFollowed ? "Unfollow" : "follow"
      }</button>
            </div>
            <h3 class="caption">
              ${elem.caption}
          ...
          <div class="engage">
            <div id=${idx} class="love">
            <div class="like-icon icon " >${elem.isLiked
        ? '<i class="like ri-heart-3-fill"></i>'
